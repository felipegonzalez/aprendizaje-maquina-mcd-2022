...
- Si tomamos $k$ más grande, podemos quizá reducir sesgo de estimación,
pero entonces el sesgo por especificación puede ser más grande (pues promediamos sobre regiones relativamente grandes), y perdemos la supuesta ventaja del método local.

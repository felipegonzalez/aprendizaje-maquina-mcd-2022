...
**Observación**: Usualmente el término variabilidad se refiere a la variación de un estimador alrededor de su valor esperado, cuando observamos sus distintas posibles estimaciones a lo largo de varias muestras de entrenamiento. Podemos descomponer el segundo término 
de arriba como:
...
el segundo término puede ser igual a cero).

...
**Observación**: Generalmente el término variabilidad se refiere a la variación de un estimador alrededor de su valor esperado, cuando observamos sus distintas posibles estimadociones a los largo de varias muestras de entrenamiento. Podemos descomponer el segundo término 
de arriba como:
...
de un tamaño fijo $n$ que podríamos obtener. El segundo
término puede llamarse variabilidad, mientras que el primero es el sesgo que obtenemos al usar una muestra $n$ finita.
